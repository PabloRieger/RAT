...
$OsLocalizacaoId= $Localizacao['completename'];
...
<tr><td width="50%"><b>Localizacão: </b><?php echo ($OsLocalizacaoId)?></td><td ></tr>
<!-- tabela OS -->
...
<tr><td height="150" colspan="2" valign="top" style="padding:10px;"><?php echo nl2br($OsDescricao);?></td></tr>
...
<tr><td height="5" colspan="2" valign="top" style="padding:10px;"><?php echo html_entity_decode($OsSolucao);?></td></tr>
<tr><td colspan="2" style="background-color:<?php echo $CorPlugin; ?> !important"><center><b><font color="<?php echo $CorTextoPlugin; ?>">DETALHES DE CUSTO</font></b></center></tr></td>
<td height="80" colspan="2" valign="top" style="padding:10px;" >
<?php
...
<tr><td colspan="2" style="background-color:<?php echo $CorPlugin; ?> !important"><center><b><font color="#FFFFFF">ASSINATURAS</font></b></center></td></tr>
</table>
<br />
<br />
<br />
